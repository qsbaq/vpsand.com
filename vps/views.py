...
def index(request):
    goods = Goods.objects.all().values('pid','company','dc',"cpu",'ram','disk','bandwidth','traffic','route','ipv4','arch','annual','quarter','month','stock','company__name','company__url','company__connect_pid','is_topic').order_by('-is_topic')
